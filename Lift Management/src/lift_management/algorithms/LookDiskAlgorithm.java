...
public class LookDiskAlgorithm extends LiftAlgorithm<Direction>{
	...
	@Override
	public int evaluate(List<Task<Direction>> tasks, int requestedFloor, Direction requestedDirection, int maxBuildingFloor, int currentPosition, int liftID) throws Exception{
